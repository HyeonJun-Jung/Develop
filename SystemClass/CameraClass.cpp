...
void CameraClass::CameraMove(Camera_Move_Dir MoveDir)
{
	...
	switch (MoveDir)
	{
		case MD_FRONT:
		{
			...
			m_lookAt.x += MoveVal * ForwardDirection.x;
			m_lookAt.y += MoveVal * ForwardDirection.y;
			m_lookAt.z += MoveVal * ForwardDirection.z;
		...
		case MD_LEFT:
		{
			...
			/*
			m_lookAt.x -= MoveVal * RightDirection.x;
			m_lookAt.y -= MoveVal * RightDirection.y;
			m_lookAt.z -= MoveVal * RightDirection.z;
			*/
			break;
		}
		case MD_RIGHT:
...
void CameraClass::CameraRotation(Camera_Rotation_Dir RotationDir)
{
	...
	switch (RotationDir)
	{
		...
		case RT_LEFT:
		{
			m_lookAt.x -= Rotationval * RightDirection.x;
			m_lookAt.z -= Rotationval * RightDirection.z;
			break;
		}
		case RT_RIGHT:
		{
